...
class Hello(object):
    ...
    def index(self):
        ...
        return outstring
    #@+node:2015.20150512115634.1: *3* drawspur
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150512115719.1: *3* drawspuraction
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def mygeartest2(self, N=20, m=15, p=5,z=15,x=24):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    ctx.fillText("40223144",x_g1-60, y_g1-10)
